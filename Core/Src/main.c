...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, IR4_Pin|IR2_Pin|IR1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IR5_GPIO_Port, IR5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(MCU_LED_GPIO_Port, MCU_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : IR4_Pin IR2_Pin IR1_Pin */
  GPIO_InitStruct.Pin = IR4_Pin|IR2_Pin|IR1_Pin;
